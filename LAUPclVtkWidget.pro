#-------------------------------------------------
#
# Project created by QtCreator 2019-02-21T10:43:16
#
#-------------------------------------------------

QT       += core gui widgets

TARGET = LAUPclVtkWidget
TEMPLATE = app

INCLUDEPATH    += /usr/local/include /usr/local/include/eigen3 /usr/local/include/vtk-8.1 /usr/local/include/pcl-1.9
DEPENDPATH     += /usr/local/include /usr/local/include/eigen3 /usr/local/include/vtk-8.1 /usr/local/include/pcl-1.9
...
LIBS += -lboost_atomic-mt \
        ...
        -lboost_signals-mt \
        -lboost_stacktrace_addr2line-mt \
        ...
        -lvtkInfovisBoostGraphAlgorithms-8.1 \
        -lvtkInfovisCore-8.1 \
        ...
        -lvtkRenderingFreeTypeFontConfig-8.1 \
        ...
        -lpcl_io_ply.1.9.1 \
        -lpcl_kdtree.1.9.1 \
        -lpcl_keypoints.1.9.1 \
        -lpcl_ml.1.9.1 \
        -lpcl_octree.1.9.1 \
        -lpcl_outofcore.1.9.1 \
        -lpcl_people.1.9.1 \
        -lpcl_recognition.1.9.1 \
        -lpcl_registration.1.9.1 \
        -lpcl_sample_consensus.1.9.1 \
        -lpcl_search.1.9.1 \
        -lpcl_segmentation.1.9.1 \
        -lpcl_simulation.1.9.1 \
        -lpcl_simulation_io.1.9.1 \
        -lpcl_stereo.1.9.1 \
        -lpcl_surface.1.9.1 \
        -lpcl_tracking.1.9.1 \
        -lpcl_visualization.1.9.1
